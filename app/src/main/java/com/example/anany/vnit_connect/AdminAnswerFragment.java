...
import com.example.anany.vnit_connect.adapters.AdminAns_descAdapter;
...
public class AdminAnswerFragment extends Fragment {
    ...
    private AdminAns_descAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_admin_answer, container, false);
        this.mView = view;
        context = getActivity();
        ...
        firestoreListener = db.collection("answers").whereEqualTo("abuse","true")
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                        ...
                        mAdapter = new AdminAns_descAdapter(quesList, context, db);
        ...
        db.collection("answers").whereEqualTo("abuse","true").get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        mAdapter = new AdminAns_descAdapter(aList, context, db);
